...
export default config({
  ...
  collections: {
      ...
      schema: {
        ...
        category: fields.select({
          ...
          options: [
            ...
            { label: "Lakes & Rivers", value: "Lakes & Rivers" },
            { label: "Trekking & Hiking", value: "Trekking & Hiking" },
            { label: "Culture & Museum", value: "Culture & Museum" },
            { label: "Adventure & Sports", value: "Adventure & Sports" },
            { label: "Valley & Landscape", value: "Valley & Landscape" },
            { label: "Natural Wonder", value: "Natural Wonder" },
            { label: "Parks & Gardens", value: "Parks & Gardens" },
          ],
          ...
          fields.object({
            hub_name: fields.select({
              ...
              options: [
                ...
                { label: "Guwahati (Road)", value: "Guwahati" },
                { label: "Tawang (Road)", value: "Tawang" },
                { label: "Sivasagar (Road)", value: "Sivasagar" },
                { label: "Shillong (Road)", value: "Shillong" },
                { label: "Kohima (Road)", value: "Kohima" },
                { label: "Cherrapunji (Road)", value: "Cherrapunji" },
                { label: "Pelling (Road)", value: "Pelling" },
                { label: "Majuli (Road)", value: "Majuli" },
                { label: "Kaziranga (Road)", value: "Kaziranga" },
                { label: "Jowai (Road)", value: "Jowai" },
                { label: "Gangtok (Road)", value: "Gangtok" },
                { label: "Wokha (Road)", value: "Wokha" },
                { label: "Champhai (Road)", value: "Champhai" },
                { label: "Dawki (Road)", value: "Dawki" },
                { label: "Dirang (Road)", value: "Dirang" },
                { label: "Imphal (Road)", value: "Imphal" },
                { label: "Mawlynnong (Road)", value: "Mawlynnong" },
                { label: "Udaipur (Road)", value: "Udaipur" },
                { label: "Ukhrul (Road)", value: "Ukhrul" },
              ],
    ...
    hubCities: collection({
      label: "Hub Cities",
      slugField: "id",
      path: "src/content/hub-cities/*",
      format: { contentField: "body" },
      entryLayout: "form",
      schema: {
        id: fields.text({
        ...
        // ── Hub Images ───────────────────────────────────
        hub_images: fields.array(fields.text({ label: "Image path" }), {
          label: "Hub Images (banner + card)",
          description: "First image = banner, second = card thumbnail",
          itemLabel: (props) => props.value || "New image",
